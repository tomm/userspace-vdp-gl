...
void VGA4Controller::readEmulatorScreen(RGB888 * destBuf)
{
  ...
  for (int y = 0; y < height; ++y) {
    ...
    uint32_t *dest = (uint32_t*)scanline_buf;

    auto const packedPaletteIndexQuad_to_signals = (uint32_t *) getSignalsForScanline(y);
