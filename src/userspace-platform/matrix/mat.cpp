...
esp_err_t dspm_mulc_f32(const float *input, float *output, float C, int rows, int cols, int padd_in, int padd_out, int step_in, int step_out)
{
    if (NULL == input) {
        return ESP_ERR_DSP_PARAM_OUTOFRANGE;
    }
...
esp_err_t dspm_mult_ex_f32(const float *A, const float *B, float *C, int A_rows, int A_cols, int B_cols, int A_padding, int B_padding, int C_padding)
{
    if (NULL == A) {
        return ESP_ERR_DSP_PARAM_OUTOFRANGE;
    }
...
esp_err_t dsps_sub_f32(const float *input1, const float *input2, float *output, int len, int step1, int step2, int step_out)
{
    if (NULL == input1) {
        return ESP_ERR_DSP_PARAM_OUTOFRANGE;
    }
...
esp_err_t dspm_sub_f32(const float *input1, const float *input2, float *output, int rows, int cols, int padd1, int padd2, int padd_out, int step1, int step2, int step_out)
{
    if (NULL == input1) {
        return ESP_ERR_DSP_PARAM_OUTOFRANGE;
    }
...
Mat &Mat::operator+=(float C)
{
    if (this->sub_matrix) {
        ...
        dsps_addc_f32(this->data, this->data, this->length, C, 1, 1);
    }
    return *this;
}
...
Mat &Mat::operator*=(float num)
{
    if (this->sub_matrix) {
        ...
        dsps_mulc_f32(this->data, this->data, this->length, num, 1, 1);
    }
    return *this;
}
...
Mat &Mat::operator/=(float num)
{
    if (this->sub_matrix) {
        ...
        dsps_mulc_f32(this->data, this->data, this->length, 1 / num, 1, 1);
    }
    return *this;
}
